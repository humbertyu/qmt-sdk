...
SAMPLES = {
    ...
    "get_history_data": {"field_list": ["close"], "stock_list": ["000001.SZ"], "period": "1d", "count": 2},
    "get_svol": {"stock": "000001.SZ"}, "get_bvol": {"stock": "000001.SZ"},
    "get_turnover_rate": {"stock_code": "000001.SZ"},
    "get_longhubang": {"stock_code": "000001.SZ", "start_date": "20260901", "end_date": "20260902"},
    "get_north_finance_change": {"start_date": "20260901", "end_date": "20260902"},
    "get_hkt_details": {"start_date": "20260901", "end_date": "20260902"},
    "get_hkt_statistics": {"start_date": "20260901", "end_date": "20260902"},
    ...
    "get_his_st_data": {"stock_code": "000001.SZ", "start_time": "20260101", "end_time": "20260902"},
    "get_main_contract": {"exchange": "SHFE", "product": "IF"},
    "get_contract_multiplier": {"stock_code": "IF.CFFEX"}, "get_contract_expire_date": {"stock_code": "IF.CFFEX"},
    "get_his_contract_list": {"exchange": "CFFEX", "product": "IF", "start_time": "20260101", "end_time": "20260902"},
    ...
    "get_weight_in_index": {"index_code": "000300.SH", "stock_list": ["000001.SZ"]},
}
