...
def _handle(ContextInfo, request):
    ...
    native_shapes = {
        ...
        "get_option_detail_data": ((params.get("optioncode", params.get("option_code", params.get("stock_code", ""))),),),
        "get_option_undl_data": ((params.get("undl_code_ref", params.get("option_code", params.get("stock_code", ""))),),),
